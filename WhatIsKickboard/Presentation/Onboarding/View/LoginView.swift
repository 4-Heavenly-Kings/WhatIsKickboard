...
final class LoginView: BaseView {
    ...
    private let emailUITextField = UITextField()
    private let passwordUITextField = UITextField()
    ...
    override func setStyles() {
        ...
        inputStackView.do {
            ...
            $0.spacing = 20
            $0.alignment = .center
            $0.addArrangedSubviews(emailUITextField, passwordUITextField, loginButton, navigationStackView)
        }
    ...
    override func setLayout() {
        ...
        emailUITextField.snp.makeConstraints {
            $0.height.equalTo(50)
            $0.width.equalToSuperview()
        }
        
        passwordUITextField.snp.makeConstraints {
            $0.height.equalTo(50)
            $0.width.equalToSuperview()
        }
